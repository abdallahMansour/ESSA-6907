...
export function* fetchProjectById(action) {
  try {
    ...
    yield put({ type: CONSTANTS.FETCH_PROJECT_BY_ID_FAILURE })
  }
}
...
export function* fetchProjectStatsById(action) {
  try {
    ...
    console.log('e: ', e)
    yield put({ type: CONSTANTS.FETCH_PROJECT_STATS_BY_ID_FAILURE })
  }
}
...
export function* fetchProjectMembersByProjectId(action) {
  try {
    ...
    console.log('e: ', e)
    yield put({ type: CONSTANTS.FETCH_PROJECT_MEMBERS_BY_PROJECT_ID_FAILURE })
  }
}
...
export function* fetchProjectMembersByFilter(action) {
  try {
    ...
    console.log('e: ', e)
    yield put({ type: CONSTANTS.FETCH_PROJECT_MEMBERS_BY_FILTER_FAILURE })
  }
}
...
export function* addMember(action) {
  try {
    ...
    yield put({ type: CONSTANTS.ADD_PROJECT_MEMBER_FAILURE })
  }
}
...
export function* deleteMember(action) {
  try {
    ...
    yield put({ type: CONSTANTS.DELETE_PROJECT_MEMBER_FAILURE })
  }
}
...
export function* updateProject(action) {
  try {
    ...
    console.log('e: ', e)
    yield put({ type: CONSTANTS.UPDATE_PROJECT_FAILURE })
  }
}
