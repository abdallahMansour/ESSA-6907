...
const Editor = ({
  ...
  replicatedPageManager.setSendCallback((operations, pageId) => {
    if (isConnectedToLiveshare)
      sendContentOperationMessage(skillId, pageId, operations)
  })
  replicatedPageManager.setConnectionStatus(isConnectedToLiveshare)
